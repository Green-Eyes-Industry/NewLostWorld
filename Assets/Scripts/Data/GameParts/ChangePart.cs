...
namespace Data.GameParts
{
    ...
    public class ChangePartGUInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            for (int i = 0; i < _changePart.buttonText.Length; i++)
            {
                ...
                if (_changePart.movePart[i] != null && GUILayout.Button(_dellConnect, GUILayout.Width(40), GUILayout.Height(40))) _changePart.movePart[i] = null;
            ...
            if (_changePart.mainEvents != null) GlobalHelperGUInspector.ShowPartEventList(_changePart.mainEvents);
